...
- [assistant](./bluer_agent/docs/assistant.md)
...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/README), based on 👾 [`bluer_agent-5.425.1`](https://github.com/kamangir/bluer-agent).
