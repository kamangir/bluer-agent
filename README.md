...
|   |   |
| --- | --- |
| [`chat`](./bluer_agent/docs/chat) [![image](https://github.com/kamangir/assets2/raw/main/bluer-agent/icon.jpg?raw=true)](./bluer_agent/docs/chat)  | [`transcription`](./bluer_agent/docs/transcription) [![image](https://github.com/kamangir/assets2/raw/main/bluer-agent/icon.jpg?raw=true)](./bluer_agent/docs/transcription)  |
...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/README), based on 👾 [`bluer_agent-5.21.1`](https://github.com/kamangir/bluer-agent).
